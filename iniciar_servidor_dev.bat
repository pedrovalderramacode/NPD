@echo off
title PRODUÇÃO - Servidor de Producao (Desenvolvimento)
color 0B
...
echo ========================================
echo   PRODUÇÃO - Modo Desenvolvimento
echo ========================================
echo.
...
echo va ate a pasta do projeto e execute iniciar_servidor_dev.bat novamente.
pause
exit /b 0
...
echo Iniciando servidor Flask (modo desenvolvimento) na porta 8082...
echo.
...
REM Inicia o servidor usando app.py (modo desenvolvimento)
python app.py
